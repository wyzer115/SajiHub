        ...
        <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-50 w-[260px] bg-dark-900 border-r border-dark-800 transform -translate-x-full lg:translate-x-0 sidebar-transition flex flex-col h-full shadow-2xl">
            ...
            <div class="h-16 flex items-center px-6 border-b border-dark-800">
                <a href="#" class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-brand-500/20 text-brand-500 flex items-center justify-center">
                    ...
                    <span class="text-xl font-bold text-white tracking-tight">Saji<span class="text-brand-500">HUB</span></span>
                </a>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-1 scrollbar-thin">
                @if($user && $user->isSuperAdmin())
                    ...
                    <a href="{{ route('superadmin.reports') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('superadmin.reports') ? 'bg-brand-500/10 text-brand-500 border-l-2 border-brand-500' : 'text-dark-300 hover:bg-dark-800 hover:text-white transition-colors' }}">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                        <span class="font-medium text-sm">Laporan Omzet Global</span>
                    </a>
                    ...
                    <a href="{{ route('superadmin.users.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('superadmin.users.*') ? 'bg-brand-500/10 text-brand-500 border-l-2 border-brand-500' : 'text-dark-300 hover:bg-dark-800 hover:text-white transition-colors' }}">
                        ...
                        <span class="font-medium text-sm">Kelola Admin Cabang</span>
                    </a>
                @endif
                ...
                @if($user && $user->isAdminCabang())
                    ...
                    <a href="{{ route('admin.tables.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.tables.*') ? 'bg-brand-500/10 text-brand-500 border-l-2 border-brand-500' : 'text-dark-300 hover:bg-dark-800 hover:text-white transition-colors' }}">
                        ...
                        <span class="font-medium text-sm">Meja & QR Code</span>
                    </a>
                    <a href="{{ route('admin.staff.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.staff.*') ? 'bg-brand-500/10 text-brand-500 border-l-2 border-brand-500' : 'text-dark-300 hover:bg-dark-800 hover:text-white transition-colors' }}">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        <span class="font-medium text-sm">Kelola Kasir & Dapur</span>
                    </a>
