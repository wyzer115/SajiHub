                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    @if($item->notes)
                                        <p class="text-yellow-400/80 text-xs mt-1 italic flex items-start bg-yellow-500/5 p-2 rounded-md border border-yellow-500/10">
                                            <svg class="w-3 h-3 mr-1 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                                            {{ $item->notes }}
                                        </p>
                                    @endif
                                </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-white font-medium text-base leading-tight">{{ $item->menu->name ?? 'Menu Dihapus' }}</p>
                                    @if($item->notes)
                                        <p class="text-orange-400/80 text-xs mt-1 italic flex items-start bg-orange-500/5 p-2 rounded-md border border-orange-500/20">
                                            <svg class="w-3 h-3 mr-1 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                                            {{ $item->notes }}
                                        </p>
                                    @endif
