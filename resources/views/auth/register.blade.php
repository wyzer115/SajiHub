...
<body class="bg-dark-950 font-sans antialiased min-h-screen flex items-center justify-center relative overflow-y-auto py-12">
    ...
    <div class="w-full max-w-lg px-6 z-10 animate-fade-in-up">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-brand-500/20 text-brand-500 mb-3 shadow-lg border border-brand-500/30">
            ...
            <h1 class="text-2xl font-bold text-white tracking-tight mb-1 uppercase">Waroeng Saji<span class="text-brand-500">HUB</span></h1>
